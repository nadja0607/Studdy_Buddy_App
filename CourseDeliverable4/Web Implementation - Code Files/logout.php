...
$logoutnetID = mysqli_real_escape_string($link, $_REQUEST['logoutNetID']);

$conn = new PDO('mysql:host='.$dbhst.';dbname='.$dbnme, $bdusr, $dbpws);

$sql = "UPDATE students SET status='Inactive' WHERE netID='$logoutnetID'";
$result = $conn->query($sql);

header("Location: http://localhost:8080/StudyBuddy.html");
exit();
